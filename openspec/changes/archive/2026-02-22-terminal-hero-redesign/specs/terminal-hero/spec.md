...
On desktop, social links SHALL be arranged in a horizontal row with 32px gaps. On mobile, they SHALL stack vertically with 12px gaps.
...
#### Scenario: Cursor blinks after animation
- **WHEN** the entry animation sequence completes
- **THEN** a cyan block cursor blinks with a 1.2s period at the last line of the terminal
